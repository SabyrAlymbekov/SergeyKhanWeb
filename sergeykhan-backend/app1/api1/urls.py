...
urlpatterns = [
    ...
    path('login/', LoginAPIView.as_view(), name='login'),    path('api/user/', get_user_by_token, name='get_user_by_token'),
    ...
    path('orders/<int:order_id>/update/', update_order, name='update_order'),    path('users/masters/', get_masters, name='get_masters'),
    path('users/operators/', get_operators, name='get_operators'),
    path('users/curators/', get_curators, name='get_curators'),
    path('balance/<int:user_id>/', get_user_balance, name='get_user_balance'),  # legacy
    ...
    path('api/orders/non-active/', get_non_active_orders, name='non_active_orders'),    path('orders/<int:order_id>/transfer/', transfer_order_to_warranty_master, name='transfer_order_to_warranty_master'),
    ...
    path('profit-distribution/', profit_distribution),    path('curator/fine-master/', fine_master),
    ...
    path('contacts/uncalled/', get_uncalled_contacts, name='get_uncalled_contacts'),    path('orders/guaranteed/<int:master_id>/', get_guaranteed_orders, name='get_guaranteed_orders'),
    path('orders/guaranteed/', get_all_guaranteed_orders, name='get_all_guaranteed_orders'),
    path('users/warranty-masters/', get_all_warranty_masters, name='get_all_warranty_masters'),
    path('api/distribute/<int:order_id>/', distribute_order_profit, name='distribute_order_profit'),
    ...
    # Валидация ролей    path('api/validate-role/', validate_user_role, name='validate_user_role'),
    path('api/master-panel/', master_panel_access, name='master_panel_access'),
    path('api/curator-panel/', curator_panel_access, name='curator_panel_access'),
    ...
    path('api/distance/settings/update/', update_distance_settings, name='update_distance_settings'),    path('api/distance/master/<int:master_id>/', get_master_distance_info, name='get_master_distance_info'),
    path('api/distance/masters/all/', get_all_masters_distance, name='get_all_masters_distance'),
    path('api/distance/orders/available/', get_master_available_orders_with_distance, name='get_master_available_orders_with_distance'),
