    ...
    return (<div className="flex flex-col mt-5 gap-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-16 items-start">
                ...
                <div className="rounded-xl border p-6">
                    ...
                    <UniversalBalanceManager userId={id} currentUserRole="curator" showControls={true} readonly={false}/>
                </div>
            ...
            <div className="pt-5">
                <div className="rounded-xl border p-6">
                    ...
                    <MasterCalendar masterId={parseInt(id)} userRole="curator" readOnly={true} showCreateButton={false} apiBaseUrl={API}/>
                </div>
            </div>
