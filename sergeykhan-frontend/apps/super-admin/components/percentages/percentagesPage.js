...
const PercentagesPage = () => {
    ...
    return (<div className="md:max-w-3xl md:mx-auto md:p-6">
            ...
            <div className="mb-8 border p-4 rounded">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input type="number" value={masterAdvance} onChange={(e) => setMasterAdvance(Number(e.target.value))} className="mt-1 block w-full"/>
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Сдача в кассу (%)
                        </label>
                        <Input type="number" value={masterCashDesk} onChange={(e) => setMasterCashDesk(Number(e.target.value))} className="mt-1 block w-full"/>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-8 border p-4 rounded">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input type="number" value={immediateCash} onChange={(e) => setImmediateCash(Number(e.target.value))} className="mt-1 block w-full"/>
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Зачисление на баланс мастеру (%)
                        </label>
                        <Input type="number" value={creditedBalance} onChange={(e) => setCreditedBalance(Number(e.target.value))} className="mt-1 block w-full"/>
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Куратору (%)
                        </label>
                        <Input type="number" value={curatorPercent} onChange={(e) => setCuratorPercent(Number(e.target.value))} className="mt-1 block w-full"/>
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700">
                            Касса компании (%)
                        </label>
                        <Input type="number" value={companyDesk} onChange={(e) => setCompanyDesk(Number(e.target.value))} className="mt-1 block w-full"/>
                    </div>
                </div>
            </div>
