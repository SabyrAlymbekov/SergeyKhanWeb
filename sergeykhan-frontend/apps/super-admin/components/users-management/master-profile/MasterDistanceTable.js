...
const MasterDistanceTable = ({ masterId }) => {
    ...
    const handleManualSet = async (level) => {
    ...
    const getDistanceLevelBadge = (level, name) => {
        return (<Badge variant={level === 2 ? "default" : level === 1 ? "secondary" : "outline"} className={`text-sm ${level === 2 ? "bg-green-600 hover:bg-green-700" :
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button onClick={loadDistanceData} disabled={loading} variant="outline" size="sm">
              Обновить
            </Button>
          </div>
        </div>
        ...
        <div className="space-y-4">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="mt-2 flex justify-between items-center">
                  ...
                  <Badge variant={distanceInfo.meets_requirements.standard_distance ? "default" : "outline"} className={`${distanceInfo.meets_requirements.standard_distance ? "bg-green-600" : "text-muted-foreground"}`}>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="mt-2 flex justify-between items-center">
                  ...
                  <Badge variant={distanceInfo.meets_requirements.daily_distance_by_revenue ? "default" : "outline"} className={`${distanceInfo.meets_requirements.daily_distance_by_revenue ? "bg-green-600" : "text-muted-foreground"}`}>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="mt-2 flex justify-between items-center">
                  ...
                  <Badge variant={distanceInfo.meets_requirements.daily_distance_by_turnover ? "default" : "outline"} className={`${distanceInfo.meets_requirements.daily_distance_by_turnover ? "bg-green-600" : "text-muted-foreground"}`}>
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-3">
              <Button variant="outline" size="sm" onClick={() => handleManualSet(0)} disabled={loading}>
                Базовый уровень
              </Button>
              <Button variant="outline" size="sm" onClick={() => handleManualSet(1)} disabled={loading}>
                Обычная дистанционка
              </Button>
              <Button variant="outline" size="sm" onClick={() => handleManualSet(2)} disabled={loading}>
                Суточная дистанционка
              </Button>
              <Button variant="default" size="sm" onClick={handleReset} disabled={loading || !distanceInfo.is_manual}>
