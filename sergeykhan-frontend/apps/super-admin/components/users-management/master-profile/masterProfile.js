...
const MasterProfile = ({ id }) => {
    ...
    return (<div className="flex flex-col mt-5 gap-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="flex flex-col gap-5">
                    <UniversalBalanceManager userId={id} currentUserRole="super-admin" showControls={true} readonly={false}/>
                </div>
            ...
            <div className="pt-5">
                <div className="rounded-xl border p-6">
                    ...
                    <MasterCalendar masterId={parseInt(id)} userRole="super_admin" readOnly={true} showCreateButton={false} apiBaseUrl={API}/>
                </div>
            </div>
            ...
            <div className="pt-5">{loadingOrders ? (<div>Загрузка заказов...</div>) : (<OrdersDataTable masterId={id} data={orders} columns={columns} status="curator"/>)}
            </div>
