...
export function OrderFormComponent() {
    ...
    return (<Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-2/3 space-y-6">
                <FormField control={form.control} name="number" render={({ field }) => (<FormItem>
                ...
                <FormField control={form.control} name="equipmentType" render={({ field }) => (<FormItem>
                ...
                <FormField control={form.control} name="promotions" render={({ field }) => (<FormItem>
