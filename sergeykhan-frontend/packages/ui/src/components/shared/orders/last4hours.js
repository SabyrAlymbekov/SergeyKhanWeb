...
export default function Last4hours() {
    ...
    if (!data.length)
        return <div className="p-4 text-center">Нет заказов</div>;
    return (<OrdersDataTable data={memoData} columns={memoCols} isEdit={false} isModel={false}/>);
}
